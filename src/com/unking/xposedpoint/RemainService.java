...
import com.unking.xposedpoint.task.RemainTaskRunner;
...
public class RemainService extends Service
{
    ...
    {
        valid = new RemainTaskRunner(getApplicationContext());
    }
    ...
    private void startForeground()
    {
        ...
        builder.setTicker("Remain Service Start");
        builder.setContentTitle("Foreground Service");
        builder.setContentText("this is Remain service.");
