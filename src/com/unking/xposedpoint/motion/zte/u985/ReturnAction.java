    ...
    implements Action
{
    ...
    public void handle(Command command)
    {
        try
        {
            ...
            as[0] = (new StringBuilder(String.valueOf("sendevent /dev/input/event10"))).append(" 1 158 1").toString();
            as[1] = (new StringBuilder(String.valueOf("sendevent /dev/input/event10"))).append(" 0 0 0").toString();
            as[2] = (new StringBuilder(String.valueOf("sendevent /dev/input/event10"))).append(" 1 158 0").toString();
